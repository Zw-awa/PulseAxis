...
- 作為一個真實的小型學習專案，用來學習 `BLDC`、`FOC` 和運動控制
- 作為一個可重現的實驗平台，供別人搭建類似的往復執行機構實驗
- 作為後續更深入控制演算法和機械機構探索的基礎
...
- 一根由電機驅動的執行軸
- 一個桌面級實驗平台
- 一個公開記錄「從倉庫結構到實際實作」的專案倉庫

這也意味著第一版不會一開始就試圖覆蓋所有可能的執行機構形態或完整產品場景。
