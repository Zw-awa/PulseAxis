...
- 作为一个真实的小型学习项目，用来学习 `BLDC`、`FOC` 和运动控制
- 作为一个可复现的实验平台，供别人搭建类似的往复执行机构实验
- 作为后续更深入控制算法和机械机构探索的基础
...
- 一根由电机驱动的执行轴
- 一个桌面级实验平台
- 一个公开记录“从仓库结构到实际实现”的项目仓库

这也意味着第一版不会一开始就试图覆盖所有可能的执行机构形态或完整产品场景。
